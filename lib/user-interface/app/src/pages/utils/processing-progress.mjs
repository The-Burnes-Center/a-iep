 ...
 *
 * `translation_requested` (70) is deliberately absent. It is where the
 * on-demand add-a-language path ENTERS, not a waypoint the upload pipeline
 * crosses, and including it made 70 the ceiling for the whole translate step:
 * the bar eased 65 -> 69 across 43 seconds of work and looked stuck at the
 * milestone it had just left. Leaving it out makes the next milestone above
 * both 65 and 70 the same one, `translation_complete`, which is what actually
 ...
 *   analysis_complete (65%) 47  24.2s   30.0s   47.6s  117.7s
 *   translation_cmpl (85%)  47   1.5s    1.0s    1.8s    1.9s
 *
