...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const PDF_LABELS = {
      en: { translation: 'Translation', iepSummary: 'IEP Summary', keyInsights: 'Key Insights', reference: 'Reference: Pages {pages} of original IEP document', noContent: 'No content available in {language}' },
      es: { translation: 'Traducción', iepSummary: 'Resumen del IEP', keyInsights: 'Información Clave', reference: 'Referencia: Páginas {pages} del documento IEP original', noContent: 'No hay contenido disponible en {language}' },
      zh: { translation: '翻译', iepSummary: 'IEP摘要', keyInsights: '关键信息', reference: '参考：原 IEP 文件第 {pages} 页', noContent: '没有{language}的可用内容' },
      vi: { translation: 'Bản dịch', iepSummary: 'Tóm tắt IEP', keyInsights: 'Thông tin chính', reference: 'Tham khảo: Trang {pages} của tài liệu IEP gốc', noContent: 'Không có nội dung bằng {language}' },
      ar: { translation: 'الترجمة', iepSummary: 'ملخص IEP', keyInsights: 'أبرز النقاط', reference: 'المرجع: الصفحات {pages} من مستند IEP الأصلي', noContent: 'لا يوجد محتوى متاح باللغة {language}' },
    };
