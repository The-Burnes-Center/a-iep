...
exports.handler = async (event) => {
    ...
    // to this person" means, so record it. Accounts created before this ran
    // can sit at email_verified: false indefinitely, because nothing else in
    // the flow ever sets it. Best effort: a parent who just proved possession
    // must not be turned away because an attribute write failed.
