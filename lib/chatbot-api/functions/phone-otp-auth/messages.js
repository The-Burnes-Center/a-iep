...
const MESSAGES = {
    en: {
        ...
        otpLoginEmailSubject: 'Your A-IEP login code',
        otpLoginEmailText: 'Your login code for A-IEP is: {code}\n\nThis code expires in {minutes} minutes. Do not share it with anyone.\n\nIf you did not ask for this code, you can ignore this email.',
        otpLoginEmailHtml: '<p>Your login code for A-IEP is: <strong>{code}</strong></p><p>This code expires in {minutes} minutes. Do not share it with anyone.</p><p>If you did not ask for this code, you can ignore this email.</p>',
    ...
    es: {
        ...
        otpLoginEmailSubject: 'Su código de acceso de A-IEP',
        otpLoginEmailText: 'Su código de acceso para A-IEP es: {code}\n\nEste código expira en {minutes} minutos. No lo comparta con nadie.\n\nSi usted no pidió este código, puede ignorar este correo.',
        otpLoginEmailHtml: '<p>Su código de acceso para A-IEP es: <strong>{code}</strong></p><p>Este código expira en {minutes} minutos. No lo comparta con nadie.</p><p>Si usted no pidió este código, puede ignorar este correo.</p>',
    ...
    zh: {
        ...
        otpLoginEmailSubject: '您的 A-IEP 登录验证码',
        otpLoginEmailText: '您的 A-IEP 登录验证码是：{code}\n\n验证码 {minutes} 分钟内有效。请勿与他人分享。\n\n如果您没有索取此验证码，请忽略此邮件。',
        otpLoginEmailHtml: '<p>您的 A-IEP 登录验证码是：<strong>{code}</strong></p><p>验证码 {minutes} 分钟内有效。请勿与他人分享。</p><p>如果您没有索取此验证码，请忽略此邮件。</p>',
    ...
    vi: {
        ...
        otpLoginEmailSubject: 'Mã đăng nhập A-IEP của bạn',
        otpLoginEmailText: 'Mã đăng nhập A-IEP của bạn là: {code}\n\nMã hết hạn sau {minutes} phút. Không chia sẻ mã này với ai.\n\nNếu bạn không yêu cầu mã này, bạn có thể bỏ qua email này.',
        otpLoginEmailHtml: '<p>Mã đăng nhập A-IEP của bạn là: <strong>{code}</strong></p><p>Mã hết hạn sau {minutes} phút. Không chia sẻ mã này với ai.</p><p>Nếu bạn không yêu cầu mã này, bạn có thể bỏ qua email này.</p>',
    ...
    ar: {
        ...
        otpLoginEmailSubject: 'رمز تسجيل الدخول إلى A-IEP',
        otpLoginEmailText: 'رمز تسجيل الدخول إلى A-IEP هو: {code}\n\nتنتهي صلاحية الرمز خلال {minutes} دقائق. لا تشارك هذا الرمز مع أحد.\n\nإذا لم تطلب هذا الرمز، يمكنك تجاهل هذه الرسالة.',
        otpLoginEmailHtml: '<div dir="rtl"><p>رمز تسجيل الدخول إلى A-IEP هو: <strong>{code}</strong></p><p>تنتهي صلاحية الرمز خلال {minutes} دقائق. لا تشارك هذا الرمز مع أحد.</p><p>إذا لم تطلب هذا الرمز، يمكنك تجاهل هذه الرسالة.</p></div>',
