 ...
 * clientMetadata.language -> user profile (DynamoDB) -> 'en'.
 *
 * The profile lookup is best-effort: any failure falls back to English so
 * authentication is never blocked by localization.
 */
