...
exports.handler = async (event) => {
    try {
        // InitiateAuth ClientMetadata arrives as validationData on this
        // trigger; check clientMetadata too in case of admin flows.
        const language = normalizeLanguage(
            event.request?.validationData?.language
            ?? event.request?.clientMetadata?.language
        );
