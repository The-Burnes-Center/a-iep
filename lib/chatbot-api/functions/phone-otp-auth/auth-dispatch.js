 ...
 *   - UNCONFIRMED   an account in this state CANNOT complete custom auth,
 *                   so without this it is a silent dead end with no path
 *                   out of it in code. AdminSetUserPassword
