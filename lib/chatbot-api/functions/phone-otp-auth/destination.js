...
module.exports = {
    ...
    // the send path in create-auth-challenge judges a destination by the same
    // rule /auth/start vetted it with: two expressions that mean "a real
    // number" drift, and the looser of the two decides what reaches the
    // carrier.
    E164,
